...
const AuthorDynamic = () => {
  ...
  const data = useSelector((state: RootState) => state.dynamicAuthor.data)
  const pending = useSelector((state: RootState) => state.dynamicAuthor.pending)
